...
# Attach experiment
nl@experiment <- experiment(expname = "scenario3_forest",
                            idrunnum = "nlrx-info",
                            outpath = outpath,
                            repetition = 1,
                            idsetup = "setup",
                            ...
                            constants = list("init-composition-file" = "\"parameter_files/initial_forest_composition.dat\"",
                                            "perc-seed" = 0.57,
...
# Attach experiment
nl@experiment <- experiment(expname = "scenario3_shrub",
                            idrunnum = "nlrx-info",
                            outpath = outpath,
                            repetition = 1,
                            idsetup = "setup",
                            ...
                            variables = list("fire-frequency" = list(min = 0.0, max = 0.2, step = 0.01, qfun = "qunif"),
                                             ...
                                             "invasion?" = list(min = 0, max = 1, qfun = "qunif"),
                                             "terrain-type" = list(min = 0, max = 1, qfun = "qunif")),
                            constants = list("init-composition-file" = "\"parameter_files/initial_shrubland_composition.dat\"",
                                            "perc-seed" = 0.57,
                                            "fraction-seed-ldd" = 0.15,
                                            "seed-pred" = 0.0,
                                             "track-stalled?" = "false",
...
# Attach experiment
nl@experiment <- experiment(expname = "scenario4_forest",
                            idrunnum = "nlrx-info",
                            outpath = outpath,
                            repetition = 1,
                            idsetup = "setup",
...
# Attach experiment
nl@experiment <- experiment(expname = "scenario4_shrub",
                            idrunnum = "nlrx-info",
                            outpath = outpath,
                            repetition = 1,
                            idsetup = "setup",
